...
//   @override
//   void initState() {
//     selectedImageUrl = product.images?.first.url ?? '';
//     selectedSize = product.size?.first.toString() ?? '';
//     super.initState();
//   }
...
//         onTap: () => setSelectedImageUrl(product.images?.first.url ?? ''),
//         child: Container(
//           height: 50,
//           width: 50,
...
//             color: Colors.white,
//             border: selectedImageUrl == product.images
//                 ? Border.all(
...
class _ProductScreenState extends State<ProductScreen> {
  ...
  @override
  void initState() {
    selectedImageUrl = (product.images?.first.url ?? '') as String?;
